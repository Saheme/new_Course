package edu.javaRushCourse.JavaSyntax.level6.lesson1;

/**
 *
 В методе main проинициализируй переменную desert массивом элементов типа int и размером 10. Третьему элементу массива присвой значение 5. Остальные элементы не трогай.
