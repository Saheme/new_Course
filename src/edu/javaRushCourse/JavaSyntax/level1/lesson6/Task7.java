package edu.javaRushCourse.JavaSyntax.level1.lesson6;

/**
 * Нужно закомментировать строки кода, чтобы робот уборщик, перемещаясь по городу, убирал листья и мусор, но не убирал животных, людей и птиц.
 * <
 * Требования:
