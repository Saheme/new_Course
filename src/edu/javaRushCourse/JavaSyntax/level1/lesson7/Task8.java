package edu.javaRushCourse.JavaSyntax.level1.lesson7;

/**
 * Информационная сеть поражена. Новости не отражают подлинной ситуации.
 * Итак, теперь, когда все задачи решены, ты сможешь написать антивирус, который остановит взлом ТВ канала. Нужно остановить атаку вирусов, идущих по ТВ каналу. При помощи трех антивирусных утилит, которые могут наносить повреждения вирусам.
 * <
