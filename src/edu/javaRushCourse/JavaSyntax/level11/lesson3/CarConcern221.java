 ...
 */
public class CarConcern221 {
    private final String manufacturer = "Lamborghini";
    private final String model;
    private final int year;
    private final String color;

    public CarConcern221(String model, int year, String color) {
        this.model = model;
        this.year= year;
        this.color = color;
    }

    public CarConcern221(String model, int year) {
        this.model = model;
        this.year= year;
        this.color = "Оранжевый";
    }

    public CarConcern221(String model) {
        this.model = model;
        this.year= 4321;
        this.color = "Оранжевый";
    }
