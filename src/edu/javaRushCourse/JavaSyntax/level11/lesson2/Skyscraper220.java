package edu.javaRushCourse.JavaSyntax.level11.lesson2;
 ...
 */
public class Skyscraper220 {


        private int floorsCount;
        private String developer;

        public Skyscraper220(){
            floorsCount =5;
            developer = "JavaRushDevelopment";
        }
        public Skyscraper220(int floorsCount,String developer){
            this.floorsCount= floorsCount;
            this.developer = developer;
        }

        public static void main(String[] args) {
            Skyscraper220 skyscraper = new Skyscraper220();
            Skyscraper220 skyscraperUnknown = new Skyscraper220(50, "Неизвестно");
        }
    }
