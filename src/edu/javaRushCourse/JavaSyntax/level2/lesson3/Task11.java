package edu.javaRushCourse.JavaSyntax.level2.lesson3;

/**
 * На развилке стоит робот полицейский. Направо дорога ведет в суд, налево дорога ведет в город.
 * К робокопу по очереди идут преступники и обычные жители, а он одних отправляет в суд, а других отпускает.
 ...
 * <p>
 * Требования:
 * •	В методе main объяви 4 переменных.
 * •	Имена переменных должны быть id, age, documents и behavior.
...
public class Task11 {
    public static void main(String[] args) {
        int id = 10, age = 55;
        String documents = "passport", behavior = "deadly";
    }
